...
def create_SQL_tables(c):
    ...
    # Create UpdatePublications table - It will be used to create Publication nodes
    # id: Primary key of the publication
    # title: Title of the publication
    # year: Year of the publication
    # pmcid: PMCID of the publication
    # pmid: PMID of the publication
    # doi: DOI of the publication
    c.execute('''DROP TABLE IF EXISTS UpdatePublications''')
    c.execute('''CREATE TABLE IF NOT EXISTS "UpdatePublications" (
                    "id"	TEXT NOT NULL,
                    "title"	TEXT NOT NULL,
                    "year" INTEGER,
                    "pmcid" TEXT,
