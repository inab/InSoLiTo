...
toolsList = ["seurat", "tiedie", "yalla", "boolnet", "cellmodeller", "chemchain", "fastcore", "mongoose",
              "optimusqual", "physicell", "kpnn", "booleannet", "carnival", "openmole", "ginsim", "biolqm"]
...
MetaCitationsReduction_filtered = filter_dataframe(MetaCitationsReduction, toolsList, True, None)
